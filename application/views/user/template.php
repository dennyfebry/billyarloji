                    ...
                    <div class='dropdown colTemplate navMenu'>
                        ...
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a
                                        href="<?php echo base_url(); ?>product/<?php echo $row->id; ?>/<?php echo $brands->id; ?>"><?php echo $brands->brand; ?></a>
                                </li>
                                <?php } ?>
                            </ul>
                        </a>
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="productColumn-6">
                                ...
                                <div id="<?= $row->id ?>" class="tabcontent">
                                    ...
                                    foreach ($brand as $brands) { ?>
                                    <button
                                        onclick="location.href='<?php echo base_url(); ?>product/<?php echo $row->id; ?>/<?php echo $brands->id; ?>'"><?php echo $brands->brand; ?></button>
                                    <?php } ?>
                                </div>
                                <?php } ?>
                            </div>
