                    ...
                    <div class='dropdown colTemplate navMenu'>
                        ...
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a
                                        href="<?php echo base_url(); ?>user/C_product/product/<?php echo $row->id; ?>/<?php echo $brands->id; ?>"><?php echo $brands->brand; ?></a>
                                </li>
                                <?php } ?>
                            </ul>
                        </a>
                        ...
                        <div class="modal-body row">
                            <div class="productColumn-3">
                                <div class="tab br-white">
                                    <?php
                                foreach ($menu as $row) { ?>
                                    <button class="tablinks" onclick="openCity(event, '<?= $row->id ?>')"
                                        id="defaultOpen"><?php echo $row->category; ?></button>
                                    <?php
                                } ?>
                                </div>
                            </div>
                            <div class="productColumn-6">
                                ...
                                foreach ($brand as $brands) { ?>
                                    <button
                                        onclick="location.href='<?php echo base_url(); ?>user/C_product/product/<?php echo $row->id; ?>/<?php echo $brands->id; ?>'"><?php echo $brands->brand; ?></button>
                                    <?php } ?>
                                </div>
                                <?php } ?>
                            </div>
