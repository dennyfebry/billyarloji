                    ...
                    <li class="productColumn">
                        <div class="thumbnail">
                            <div class="productImage">
                                ...
                                <a href="<?php echo base_url(); ?>product_detail/<?php echo encrypt_url($row->id) ?>" class="more show_hide">
                                    <i class="icon-plus" onclick="location.href='<?php echo base_url(); ?>product_detail/<?php echo encrypt_url($row->id) ?>'"></i>
                                </a>
                            </div>
                            <div class="mask" onclick="location.href='<?php echo base_url(); ?>product_detail/<?php echo encrypt_url($row->id) ?>'">
                            </div>
