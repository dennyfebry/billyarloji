                        ...
                        <li class="productColumn">
                            <div class="thumbnail">
                                <div class="productImage">
                                    ...
                                    <a href="<?php echo base_url(); ?>user/C_productdetail/detail/<?php echo $row->id ?>" class="more show_hide">
                                        <i class="icon-plus" onclick="location.href='<?php echo base_url(); ?>user/C_productdetail/detail/<?php echo $row->id ?>'"></i>
                                    </a>
                                </div>
                                <div class="mask" onclick="location.href='<?php echo base_url(); ?>user/C_productdetail/detail/<?php echo $row->id ?>'">
                                </div>
