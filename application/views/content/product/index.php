                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>index.php/product/edit/<?php echo $row->id; ?>">Edit</a> |
                                            <a href="<?php echo base_url(); ?>index.php/product/delete/<?php echo $row->id; ?>">Delete</a></td>
                                    </tr>
                                <?php
                                    $no++;
                                }
