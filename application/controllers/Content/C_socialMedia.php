...
class C_socialMedia extends CI_Controller
{
    var $data = array();
    ...
    function __construct()
    {
        ...
        $this->load->model('m_socialMedia', 'ref');
        $this->load->library('form_validation');
        $this->data = array(
            'titlepage' => 'Social Media'
        );
    }
    ...
    {
        $data = $this->data;
        $data['page'] = "socialMedia/index";
        $data['socialMedia'] = $this->ref->getAll();
